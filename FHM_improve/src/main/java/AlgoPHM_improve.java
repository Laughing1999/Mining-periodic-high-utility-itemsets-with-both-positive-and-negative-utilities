...
public class AlgoPHM_improve {
	...
	* the idea is to always reuse the same buffer to reduce memory usage. */
	 ...
	 */
	public void runAlgorithm(int thresholdID,boolean improve, String input, String output, int minUtility, int minPeriodicity, int maxPeriodicity, int minAveragePeriodicity, int maxAveragePeriodicity) throws IOException {
		// reset maximum
